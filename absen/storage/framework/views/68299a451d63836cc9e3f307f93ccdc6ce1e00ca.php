                ...
                <nav class="sidebar-nav" id="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <div id="wrapper-sidebar">
                            ...
                            <li class="sidebar-item"> 
                                 <a class="sidebar-link waves-effect waves-dark " href="<?php echo e(url('/ibadah')); ?>" aria-expanded="false"><img class="col-1" src="<?php echo e(asset('/assets/img/050-edition-black.png')); ?>"></img>
                                 <span class="hide-menu">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Absen</span>
                                </a> 
                            </li>
                            <li class="sidebar-item"> 
                                 <a class="sidebar-link waves-effect waves-dark " href="<?php echo e(url('/listjemaat')); ?>" aria-expanded="false"><img class="col-1" src="<?php echo e(asset('/assets/img/user-black.png')); ?>"></img>
