            ...
            <?php echo csrf_field(); ?>
                ...
                <div class="form-group row <?php if($datas->foto == "" ?  print('hide') : print('') )?>" >
                    ...
                    <div class="col-sm-10 h-50">
                        <img class="col-12 no-absen " style="width: 20%;<?php if($datas->foto != "" ?  print('display: block;') : print('display: none;') )?>" src="<?php echo e(asset('/absen/storage/app/public/'.$datas->foto)); ?>" id="foto-jemaat" alt="<?php echo e($datas->foto); ?>">
