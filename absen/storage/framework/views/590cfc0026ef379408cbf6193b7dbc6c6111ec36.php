        ...
        <div class="container-fluid">
            ...
            <?php echo csrf_field(); ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="kecamatan"  value="<?php echo e($datas->kecamatan); ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <input type="text" class="form-control" name="kelurahan"  value="<?php echo e($datas->kelurahan); ?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row <?php if($datas->foto == "" ?  print('hide') : print('') )?>" >
                    ...
                    <div class="col-sm-10 h-50">
                        <img class="col-12 no-absen " style="width: 30%;<?php if($datas->foto != "" ?  print('display: block;') : print('display: none;') )?>" src="<?php echo e(asset('/absen/storage/app/public/'.$datas->foto)); ?>" id="foto-jemaat" alt="<?php echo e($datas->foto); ?>">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.layoutsuperadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\absen\absen\resources\views/superadmin/jemaat/showjemaat.blade.php ENDPATH**/ ?>