                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <?php if(Session::has('status')): ?>
                                            <span class="error mb-2"> <?php echo e(Session::get('status')); ?></span>
                                        <?php endif; ?>
                                    </div>
                                    <div class="col-4">
                                    ...
                                    <?php $no = 1;?>
                                        <?php $__currentLoopData = $birthdays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $birthdayKey => $birthdayDate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-6 pt-2"><?php echo e($no); ?>.&nbsp;&nbsp;<?php echo e($birthdayKey); ?></div>
                                                <div class="col-3 pt-2"><?php echo e($explodeBirthdayDate[0]); ?></div>
                                                <div class="col-3 btn-send">
                                                    <a href="<?php echo e(url('/api/sendmessage',$explodeBirthdayDate[1])); ?>" id="phone-<?php echo e($phone); ?>" style="color:white;border-radius:.5rem" class="btn btn-success w-100 small">Kirim</a>
                                                    <!-- <a href="<?php echo e(url('/api/sendqr',$explodeBirthdayDate[1])); ?>" id="phone-<?php echo e($phone); ?>" style="color:white;border-radius:.5rem" class="btn btn-success w-100 small">Kirim</a> -->
                                                </div>
                                                <?php $no += 1;?>
                                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.layoutsuperadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-7\htdocs\absen\absen\resources\views/superadmin/index.blade.php ENDPATH**/ ?>