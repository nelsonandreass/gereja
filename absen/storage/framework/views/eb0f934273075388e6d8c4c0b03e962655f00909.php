                                    ...
                                    <?php $no = 1;?>
                                        <?php $__currentLoopData = $birthdays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $birthdayKey => $birthdayDate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-7 pt-2"><?php echo e($no); ?>.&nbsp;&nbsp;<?php echo e($birthdayKey); ?></div>
                                                <div class="col-2 pt-2"><?php echo e($explodeBirthdayDate[0]); ?></div>
                                                <div class="col-3 btn-send">
                                                    <a href="<?php echo e(url('/api/sendmessage',$explodeBirthdayDate[1])); ?>" id="phone-<?php echo e($phone); ?>" style="color:white;border-radius:.5rem" class="btn btn-success w-100">Kirim</a>
                                                </div>
                                                <?php $no += 1;?>
                                            </div>
