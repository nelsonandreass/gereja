                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $absens; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $absen): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><a href="<?php echo e(url('/absen',[$absen->jenis,$absen->tanggal])); ?>" class="btn btn-primary">Detail</a></td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout.layoutsuperadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\absen\resources\views/superadmin/index.blade.php ENDPATH**/ ?>