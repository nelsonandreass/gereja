                ...
                <div class="row">&nbsp;</div>
                   ...
                   <center id="absen" style="display:none;">
                        ...
                        <div class="row">
                            <div class="col-4"></div>
                            <div class="col-4">
                                <img class="col-12 no-absen" style="width: 70%" src="<?php echo e(asset('/assets/img/user-black.png')); ?>" id="foto-jemaat" alt="">
                            </div>
                            <div class="col-4"></div>
...
<?php echo $__env->make('layout.layoutsuperadmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\absen\resources\views/superadmin/ibadah.blade.php ENDPATH**/ ?>